# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-11-14 01:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('SuperUser', 'SuperUser'), ('Requester', 'Requester'), ('Approver', 'Approver'), ('Purchaser', 'Purchaser'), ('Receiver', 'Receiver'), ('Payer', 'Payer')], max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='CatalogItem',
            fields=[
                ...
                ('currency', models.CharField(choices=[('USD', 'USD'), ('INR', 'INR')], default='USD', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
