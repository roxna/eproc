# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-31 22:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.IntegerField(choices=[(1, 'SuperUser'), (2, 'Requester'), (3, 'Approver'), (4, 'Purchaser'), (5, 'Receiver'), (6, 'Payer')])),
            ],
        ),
        migrations.CreateModel(
            name='CatalogItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.IntegerField(choices=[(1, 'Draft'), (2, 'Pending'), (3, 'Approved'), (4, 'Denied'), (5, 'Paid'), (6, 'Archived')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer_cos', models.ManyToManyField(related_name='vendor_cos', to='eProc.BuyerCo')),
            ],
            bases=('eProc.company',),
        ),
        migrations.AddField(
